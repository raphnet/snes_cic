...
;
;   Modified by Raphael Assenat <raph@raphnet.net> on 2020-05-05. When I
;   compiled the original file it would not work on my SNES. I disassembled
;   a .hex file I had found on the net that was working and looked at the
;   differences (mostly additional NOPs) and updated the source code here
...
;	bcf	GPIO, 0
	...
	bsf	TRISIO, 1
	bcf     STATUS, RP0
	nop			; RA: From snescic-key.hex disassembly
	movlw	0x27		; "wait" 1
	call	wait		; wait 121
	nop
	nop			; RA: From snescic-key.hex disassembly
...
die_blink	
	...
	retlw 0		; RA: From snescic-key.hex disassembly
	retlw 0		; RA: From snescic-key.hex disassembly
; -----------------------------------------------------------------------
; eeprom memory
 org __EEPROM_START
